...
WRAPPER_INIT = \
	...
	" The user is providing you with 'Source facts' and wants you to " \
	...
	" bottom. The dialogue THUS FAR consists of pairs of (1) user queries" \
	" and (2) your responses. Consider these previous queries and responses" \
	" (if any) when replying to the 'new_query' below them, but give higher"\
	" importance to the source facts still:\n\nDialogue thus far:\n"
